...
/**
 * wallet-vault.js â€” encrypted sessionStorage for derived wallet keys
 *
 * Two storage modes:
 *   â€¢ Plaintext   â€” { encrypted: false, keys: {...} }
 *   â€¢ Encrypted   â€” { encrypted: true, salt, iv, ciphertext } where
 *                   ciphertext = AES-GCM(
 ...
 *                   )
 *
 * The vault never holds the password â€” only the user does. If the user
