...
const Polyseed = (function () {
  ...
  // Horner evaluation at x=2 â€” equals 0 for a valid checksum
  ...
  // Build a fast prefixâ†’index map. Polyseed English uses the BIP-39 wordlist
  ...
  function decode(phrase) {
    ...
    // stored secret is still encrypted â€” deriving keys from it would silently
    ...
    if (data.features & ENCRYPTED_MASK) {
      throw new Error(
        ...
        'is set). Passphrase-protected Polyseeds are not supported here â€” ' +
