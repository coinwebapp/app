...
/**
 * mymonero-loader.js â€” Browser-side loader for the vendored mymonero-core
 ...
 * layer entirely and exposes the raw Emscripten module methods â€” the bridge
 * was really just a thin JS-to-C++ serialization shim and the methods we need
 * are already attached to the Module object.
 *
 * Public API:
 *
 *   await MoneroCore.load()       â†’ Promise<Module>  (idempotent, cached)
 *   MoneroCore.isLoaded()         â†’ bool
 *   MoneroCore.decodeAddress(addr, nettype)     â†’ { pub_viewKey, pub_spendKey, ... }
 *   MoneroCore.sendStep1(params)  â†’ { using_fee, mixin, final_total_wo_fee, ... }
 *   MoneroCore.sendStep2(params)  â†’ { serialized_signed_tx, tx_hash, tx_key, ... }
 *
 * `nettype` is a string: 'MAINNET' | 'TESTNET' | 'STAGENET'.
 * All parameter/result objects are JSON-serializable â€” large integers
 * (atomic amounts) are passed as decimal strings because JSBigInt tokens
 * can't cross the JSâ†”WASM boundary cleanly.
 */
...
const MoneroCore = (function () {
  ...
  // â”€â”€ Address decoding â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  /**
  ...
  // â”€â”€ Send: step 1 (pre-decoy planning) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  /**
  ...
  // â”€â”€ Send: step 2 (actual tx construction + signing) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  /**
   ...
   * broadcast. This is where the spend key is actually used â€” it lives
  ...
  // â”€â”€ Key image generation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  /**
