...
/**
 * monero-subaddress.js â€” Monero subaddress derivation
 *
 ...
 *   D'      = D + mÂ·G            (subaddress public spend)
 *   C'      = aÂ·D'               (subaddress public view)
 *   address = base58( 0x2A || D' || C' || keccak256(prefix)[0..4] )
 *
 * The (0,0) subaddress index is reserved for the primary address and must
 * NOT be encoded as a subaddress â€” it has its own (standard) network byte.
 *
...
const MoneroSubaddress = (function () {
  ...
  const SUBADDRESS_NETBYTE = 0x2A; // mainnet subaddress prefix â†’ "8..."
