...
/**
 * qr-scanner.js â€” Camera-based QR code scanner for Monero URIs
 *
...
const QrScanner = (function () {
  ...
  function tick () {
    ...
    if (code && code.data) {
      ...
      // Detected a non-Monero QR â€” keep scanning
  ...
  async function open (options) {
    ...
    if (typeof jsQR !== 'function') {
      const err = new Error('jsQR library not loaded â€” include js/jsqr.js first');
