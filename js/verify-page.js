...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // own node on the first LWS /login call â€” it never touches our default.
  ...
  function refreshDeriveBtn() {
    ...
    if (fmt) {
      ...
      // Polyseed (16 words) has embedded birthday â€” no age selection needed.
  ...
  // â”€â”€â”€ WALLET AGE BUTTONS â†’ restore height â”€â”€â”€
  // Each button computes an approximate block height based on how old the
  // wallet is. Monero blocks are ~2 min apart â†’ 720/day â†’ ~5,040/week.
  //
  ...
  seedInput.addEventListener('input', function() {
    ...
    if (rhGroup) {
      // Polyseed (16 words) has an embedded birthday â€” no need to ask.
      // For 12/13/25/other, show the age picker.
      rhGroup.style.display = (count === 16) ? 'none' : 'block';
    }
  });

  // â”€â”€â”€ SPEND KEY INPUT â”€â”€â”€
  ...
  btnWatch.addEventListener('click', () => {
    ...
    setTimeout(() => {
      try {
        ...
        // watch-only blob omits it â€” the dashboard hides spend-key-dependent
    ...
    btnCreate.addEventListener('click', () => {
      ...
      setTimeout(() => {
        try {
          ...
          // Store for Open Wallet button â€” mark as freshly created so
